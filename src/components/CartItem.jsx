...
const CartItem = ({cartItem}) => {
    ...
    const {cartID,title,price,image,quantity,ProductColor,company}=cartItem;
        ...
        <img src={image} alt={title} className='h-24 w-24 rounded-lg sm:h-32 sm:w-32 object-cover' />
         ...
         <div>
            <div className='form-control max-w-xs'>
                ...
                <select name='quantity' id='quantity' className='mt-2 select select-base select-bordered select-xs'
                value={quantity}
